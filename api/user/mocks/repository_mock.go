...
func (m *Repository) CreateUser(_u *models.User) (*models.User, error) {
	ret := m.Called(_u)
...
func (m *Repository) GetUser() ([]*models.User, error) {
	ret := m.Called()
...
func (m *Repository) UpdateUser(_u *models.User) (*models.User, error) {
	ret := m.Called(_u)
...
func (m *Repository) DeleteUser(id string) error {
	ret := m.Called(id)
...
func (m *Repository) Login(_u *models.Login) (*models.Token, error) {
	ret := m.Called(_u)
