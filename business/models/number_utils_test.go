...
func TestFormatCommas(t *testing.T) {
	...
	assert.Equal(t, "-1.00", FormatCommas("-1"))
	assert.Equal(t, "-12.00", FormatCommas("-12"))
	assert.Equal(t, "-123.00", FormatCommas("-123"))
	assert.Equal(t, "-1,234.00", FormatCommas("-1234"))
	assert.Equal(t, "-12,345.00", FormatCommas("-12345"))
	assert.Equal(t, "-123,456.00", FormatCommas("-123456"))
	assert.Equal(t, "-1,234,567.00", FormatCommas("-1234567"))
	assert.Equal(t, "-12,345,678.00", FormatCommas("-12345678"))
	assert.Equal(t, "-123,456,789.00", FormatCommas("-123456789"))
